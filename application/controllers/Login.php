...
class Login extends CI_Controller {
 	...
 	public function menus()
    {
        $output[] = '
            ...
            <li class="start tooltips menu-bar">
            	<a href="javascript:;">
				...
				<ul class="sub-menu">
					<li id="51" style="display:none;">
						<a href="'.base_url("profile").'">
							<span class="title">
							Profil Outlet</span>
						</a>
					</li>
					<li id="21" style="display:none;">
            ...
            <li class="start tooltips menu-bar">
            	<a href="javascript:;">
					...
					<span class="title">Data Person </span>
					<span class="arrow"></span>
				</a>
				<ul class="sub-menu">
					<li id="54" style="display:none;">
						<a href="'.base_url("supplier/page").'">
							<span class="title">
							Supplier </span>
						</a>
					</li>
					<li id="55" style="display:none;">
						<a href="'.base_url("customer/page").'">
							<span class="title">
							Customer </span>
						</a>
					</li>
					<li id="56" style="display:none;">
						<a href="'.base_url("salesman/page").'">
							<span class="title">
							Sales </span>
						</a>
					</li>
            ...
            <li class="start tooltips menu-bar">
            	<a href="javascript:;">
					...
					<span class="title">Data Spesifikasi </span>
					<span class="arrow"></span>
				</a>
				<ul class="sub-menu">
					<li id="22" style="display:none;">
						<a href="'.base_url("category/page").'">
							<span class="title">
							Kategori </span>
						</a>
					</li>
					<li id="23" style="display:none;">
						<a href="'.base_url("sub_category/page").'">
							<span class="title">
							Varian </span>
						</a>
					</li>
					<li id="24" style="display:none;">
						<a href="'.base_url("varian/page").'">
							<span class="title">
							Sub-Varian </span>
						</a>
					</li>
					<li id="25" style="display:none;">
						<a href="'.base_url("merk/page").'">
							<span class="title">
							Merk </span>
						</a>
					</li>
					<li id="26" style="display:none;">
						<a href="'.base_url("rak/page").'">
							<span class="title">
							Rak </span>
						</a>
					</li>
					<li id="27" style="display:none;">
						<a href="'.base_url("rak_wh/page").'">
							<span class="title">
							Rak Warehouse </span>
						</a>
					</li>
            ...
            <li class="start tooltips menu-bar">
				...
				<ul class="sub-menu">
					<li id="28" style="display:none;">
						<a href="'.base_url("branch/page").'">
							<span class="title">
							Branch </span>
						</a>
					</li>
					<li id="29" style="display:none;">
						<a href="'.base_url("warehouse/page").'">
							<span class="title">
							Warehouse </span>
						</a>
					</li>
            ...
            <li class="start tooltips menu-bar">
				...
				<ul class="sub-menu">
					<li id="57" style="display:none;">
						<a href="'.base_url("top/page").'">
							<span class="title">
							Term of Payment </span>
						</a>
					</li>
					<li id="58" style="display:none;">
						<a href="'.base_url("account/page").'">
							<span class="title">
							Chart of Account </span>
						</a>
					</li>
					<li id="59" style="display:none;">
						<a href="'.base_url("bank/page").'">
							<span class="title">
							Bank </span>
						</a>
					</li>
            ...
            <li class="start tooltips menu-bar">
				...
				<ul class="sub-menu">
					<li id="52" style="display:none;">
						<a href="'.base_url("user/setting").'">
							<span class="title">
							User Setting</span>
						</a>
					</li>
					<li id="53" style="display:none;">
            ...
            <li class="start tooltips menu-bar">
				...
				<ul class="sub-menu">
					<li id="60" style="display:none;">
						<a href="'.base_url("purchase/order").'">
							<span class="title">
							Order Pembelian</span>
						</a>
					</li>
					<li id="61" style="display:none;">
						<a href="'.base_url("purchase/").'">
							<span class="title">
							Faktur Pembelian</span>
						</a>
					</li>
					<li id="62" style="display:none;">
						<a href="'.base_url("purchase/").'">
							<span class="title">
							Retur Pembelian</span>
						</a>
					</li>
				</ul>
            </li>
            ...
            <li class="start tooltips menu-bar">
				...
				<ul class="sub-menu">
					<li id="31" style="display:none;">
						<a href="'.base_url("manufacture/bahan").'">
							<span class="title">
							Bahan Baku </span>
						</a>
					</li>
					<li id="32" style="display:none;">
						<a href="'.base_url("manufacture/role").'">
							<span class="title">
							Rote Price </span>
						</a>
					</li>
					<li id="41 style="display:none;"">
						<a href="'.base_url("manufacture/proses_trial").'">
							<span class="title">
							Proses Trial</span>
						</a>
					</li>
					<li id="33" style="display:none;">
