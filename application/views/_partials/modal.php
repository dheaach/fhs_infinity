											...
											<div class="tab-pane active" id="tab_general">
												<div class="form-body">
													<div class="row" style="margin-top:20px;">	
														...
														<div class="col-md-4">
															<div class="form-group">
																<label class="col-md-5 control-label" style="text-align:left;color: #10625e;">Tipe Barang
																</label>
															...
															<div class="form-group">
																...
																<div class="col-md-6">
																	<div class="checkbox-list">
																		<label><input type="checkbox" name="chk_tipe" id="chk_pjk_inc"> Pjk Inc </label>
																		<!-- <label>
														...
														<div class="col-md-4">
															...
															<div class="form-group">
																<label class="col-md-4 control-label">Varian
																</label>
																<div class="col-md-8">
															...
															<div class="form-group">
																<label class="col-md-4 control-label">Sub-Varian
																</label>
																<div class="col-md-8">
																	<select class="table-group-action-input form-control select2" id="var_brg">
																		<option value="0">None</option>
																		<?php
																			if( !empty($var) ) {
    																			foreach($var as $au) {
																					echo"<option value=".$au->varian_id.">".$au->nama."</option>";
																				}
																			}
																		?>
																	</select>
															...
															<div class="form-group">
																<label class="col-md-4 control-label">Merk
																</label>
																<div class="col-md-8">
																	<select class="table-group-action-input form-control select2" id="merk_brg">
																		<option value="0">None</option>
																		<?php
																			if( !empty($merk) ) {
    																			foreach($merk as $au) {
																					echo"<option value=".$au->merk_id.">".$au->nama."</option>";
																				}
																			}
																		?>
																	</select>
														...
														<div class="col-md-4">
															<div class="form-group">
																<label class="col-md-4 control-label">Rak
																</label>
																<div class="col-md-8">
																	<select class="table-group-action-input form-control select2" id="rak_brg">
																		<option value="0">None</option>
																		<?php
																			if( !empty($rak) ) {
    																			foreach($rak as $au) {
																					echo"<option value=".$au->rak_id.">".$au->nama."</option>";
																				}
																			}
																		?>
																	</select>
															...
															<div class="form-group">
																<label class="col-md-4 control-label">Rak-Wh
																</label>
																<div class="col-md-8">
																	<select class="table-group-action-input form-control select2" id="rakwh_brg">
																		<option value="0">None</option>
																		<?php
																			if( !empty($rak_gud) ) {
    																			foreach($rak_gud as $au) {
																					echo"<option value=".$au->rak_gudang.">".$au->nama."</option>";
																				}
																			}
																		?>
																	</select>
							...
							<div class="portlet">
								...
								<div class="portlet-body">
									<div class="tabbable">
										<ul class="nav nav-tabs">
											<li class="active">
												<a href="#tab_catinfo" data-toggle="tab">
												Infomasi </a>
											</li>
											<li>
												<a href="#tab_catacc" data-toggle="tab">
												Account </a>
											</li>
										</ul>
										<div class="tab-content no-space">
											...
											<div class="tab-pane active" id="tab_catinfo">
												<div class="form-body">
													<div class="row" style="margin-top:20px;">	
											...
											<div class="tab-pane" id="tab_catacc">
												<div class="form-body">
													<div class="row" style="margin-top:20px;">	
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																<label class="col-md-3 control-label">Persediaan <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<div class="input-group">
																		<input type="text" class="form-control" name="kat_pers" id="kat_pers">
																		<input type="hidden" class="form-control" name="id_acc_pers" id="id_acc_pers">
																		<input type="hidden" class="form-control" name="kat_pers_gol" id="kat_pers_gol">
																		<span class="input-group-btn">
																			<button class="btn green-seagreen" id="btn-pers-kat"><i class="fa fa-ellipsis-h"></i></button>
																		</span>
																	</div>
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Penjualan <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<div class="input-group">
																		<input type="text" class="form-control" name="kat_jual" id="kat_jual">
																		<input type="hidden" class="form-control" name="id_acc_jual" id="id_acc_jual">
																		<input type="hidden" class="form-control" name="kat_jual_gol" id="kat_jual_gol">
																		<span class="input-group-btn">
																			<button class="btn green-seagreen" id="btn-jual-kat"><i class="fa fa-ellipsis-h"></i></button>
																		</span>
																	</div>
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Retur <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<div class="input-group">
																		<input type="text" class="form-control" name="kat_ret" id="kat_ret">
																		<input type="hidden" class="form-control" name="kat_ret_gol" id="kat_ret_gol">
																		<input type="hidden" class="form-control" name="id_acc_ret" id="id_acc_ret">
																		<span class="input-group-btn">
																			<button class="btn green-seagreen" id="btn-ret-kat"><i class="fa fa-ellipsis-h"></i></button>
																		</span>
																	</div>
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Potongan <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<div class="input-group">
																		<input type="text" class="form-control" name="kat_pot" id="kat_pot">
																		<input type="hidden" class="form-control" name="kat_pot_gol" id="kat_pot_gol">
																		<input type="hidden" class="form-control" name="id_acc_pot" id="id_acc_pot">
																		<span class="input-group-btn">
																			<button class="btn green-seagreen" id="btn-pot-kat"><i class="fa fa-ellipsis-h"></i></button>
																		</span>
																	</div>
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">HPP <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<div class="input-group">
																		<input type="text" class="form-control" name="kat_hpp" id="kat_hpp">
																		<input type="hidden" class="form-control" name="id_acc_hpp" id="id_acc_hpp">
																		<input type="hidden" class="form-control" name="kat_hpp_gol" id="kat_hpp_gol">
																		<span class="input-group-btn">
																			<button class="btn green-seagreen" id="btn-hpp-kat"><i class="fa fa-ellipsis-h"></i></button>
																		</span>
																	</div>
																</div>
															</div>
...
<!--MODAL ADD Varian-->
<div class="modal fade" id="add_varian" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" action="#" id="frm-var">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-var"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-var"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-var"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-var"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
														...
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="kode_var" id="kode_var">
																	<input type="hidden" class="form-control" name="id_var" id="id_var">
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="nama_var" id="nama_var" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Status <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_act_var" value="1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_non_var" value="0" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="varian[kode]" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="varian[name]" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Status <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="optionsRadios" id="optionsRadios22" value="option1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="optionsRadios" id="optionsRadios23" value="option2" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
...
<!--END MODAL-->
<!--MODAL ADD Merk-->
<div class="modal fade" id="add_merk" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" action="#" id="frm-merk">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-merk"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-merk"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-merk"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-merk"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
														...
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="kode_merk" id="kode_merk">
															...
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_act_merk" value="1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_non_merk" value="0" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="merk[kode]" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="merk[name]" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Status <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="optionsRadios" id="optionsRadios24" value="option1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="optionsRadios" id="optionsRadios25" value="option2" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
...
<!--END MODAL-->
<!--MODAL ADD Rak-->
<div class="modal fade" id="add_rak" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" action="#" id="frm-rak">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-rak"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-rak"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-rak"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-rak"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
															...
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	...
																	<input type="hidden" class="form-control" name="id_rak" id="id_rak">
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
															...
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_act_rak" value="1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_non_rak" value="0" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="rak[kode]" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="rak[name]" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Status <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="optionsRadios" id="optionsRadios27" value="option1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="optionsRadios" id="optionsRadios28" value="option2" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
...
<!--END MODAL-->
<!--MODAL ADD Rak- WH-->
<div class="modal fade" id="add_rakwh" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" action="#" id="frm-rakwh">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-rakwh"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-rakwh"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-rakwh"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-rakwh"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
														...
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="kode_rakwh" id="kode_rakwh">
																	<input type="hidden" class="form-control" name="id_rakwh" id="id_rakwh">
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="nama_rakwh" id="nama_rakwh" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Status <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_act_rakwh" value="1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_non_rakwh" value="0" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="rakwh[kode]" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="rakwh[name]" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Status <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="optionsRadios" id="optionsRadios29" value="option1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="optionsRadios" id="optionsRadios30" value="option2" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
...
<!--END MODAL-->
<!--MODAL ADD branch-->
<div class="modal fade" id="add_branch" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" action="#" id="frm-branch">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-branch"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-branch"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-branch"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-branch"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
												...
												<div class="form-body">
													<div class="row" style="margin-top:20px;">	
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	...
																	<input type="hidden" class="form-control" name="id_branch" id="id_branch">
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
															...
															<div class="form-group">
																<label class="col-md-3 control-label">No Prefix <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<input type="text" class="form-control" name="prefix_branch" id="prefix_branch" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Status <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_act_branch" value="1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_non_branch" value="0" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="branch[kode]" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
															...
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="branch[no_prefix]" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Status <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="optionsRadios" id="optionsRadios31" value="option1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="optionsRadios" id="optionsRadios32" value="option2" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
...
<!--MODAL ADD warehouse-->
<div class="modal fade bs-modal-lg" id="add_warehouse" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" action="#" id="frm-warehouse">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-warehouse"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-warehouse"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-warehouse"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-warehouse"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
												...
												<div class="form-body">
													<div class="row" style="margin-top:20px;">	
														<div class="col-md-8" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="kode_gud" id="kode_gud">
																	<input type="hidden" class="form-control" name="id_gud" id="id_gud">
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="nama_gud" id="nama_gud" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Branch <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<select class="table-group-action-input form-control select2" id="cat_gud_no">
																		<?php
																			if( !empty($kat) ) {
    																			foreach($kat as $au) {
																					echo"<option value=".$au->cat_gud_no.">".$au->nama."</option>";
																				}
																			}
																		?>
																	</select>
															...
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_act_gud" value="1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_non_gud" value="0" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
														<div class="col-md-4" style="margin-bottom: 30px;">
															...
															<div class="col-sm-12">
																<div class="checkbox-list">
																	<label><input type="checkbox" name="chk_tipe" id="is_default_gud"> Default Pembelian </label>
																	<label><input type="checkbox" name="chk_tipe" id="is_jual_gud"> Default Penjualan </label>
																	<label><input type="checkbox" name="chk_tipe" id="is_produksi_gud"> Default Kasir </label>
																	<label><input type="checkbox" name="chk_tipe" id="is_kasir_gud"> Default Assembly </label>
																</div>
															</div>
														</div>
													</div>
...
<!--END MODAL-->
<!--MODAL ADD supplier-->
<div class="modal fade bs-modal-lg" id="add_supplier" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" id="frm-supplier">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-supplier"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-supplier"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-supplier"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-supplier"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
										<ul class="nav nav-tabs">
											<li class="active">
												<a href="#tab_supinfo" data-toggle="tab">
												Infomasi </a>
											</li>
											<li>
												<a href="#tab_supacc" data-toggle="tab">
												Account </a>
											</li>
										</ul>
										<div class="tab-content no-space">
											<div class="alert alert-danger alert-dismissible" id="validation-supplier" style="display:none;">
											  <a href="#" class="close" data-dismiss="alert" aria-label="close">x</a>
											</div>
											<div class="alert alert-success alert-dismissible" id="validation-s-supplier" style="display:none;">
											  <a href="#" class="close" data-dismiss="alert" aria-label="close">x</a>
											</div>
											<div class="tab-pane active" id="tab_supinfo">
												<div class="form-body">
													<div class="row" style="margin-top:20px;">	
														<div class="col-md-6" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_act_supplier" value="1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_non_supplier" value="0" checked> Non-Active </label>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-md-6">
																	<input type="text" class="form-control" name="person_code" id="person_code">
																	<input type="hidden" class="form-control" name="id_person" id="id_person">
																</div>
																<div class="col-sm-3">
																	<div class="checkbox-list">
																		<label><input type="checkbox" name="chk_tipe" id="is_default"> Default</label>
																	</div>
																</div>
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="person_telp" id="person_telp" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Hp </label>
																<div class="col-md-9">
																	<input type="text" class="form-control" name="person_hp" id="person_hp" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Alamat </label>
																<div class="col-md-9">
																	<textarea class="form-control" id="person_alamat"></textarea>
																</div>
															</div>
														</div>
														<div class="col-md-6" style="padding-right: 30px;">
															<div class="form-group">
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="person_fax" id="person_fax" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Contact </label>
																<div class="col-md-9">
																	<input type="text" class="form-control" name="person_contact" id="person_contact" >
																</div>
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="propinsi" id="propinsi" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Keterangan</label>
																<div class="col-md-9">
																	<textarea class="form-control" id="person_desc"></textarea>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="tab-pane" id="tab_supacc">
												<div class="form-body">
													<div class="row" style="margin-top:20px;">	
														<div class="col-md-6">
															<div class="form-group">
																<label class="col-md-3 control-label">Term </label>
																<?php if(!empty($page) && $page == 54 ){?>
																	<div class="col-md-9">
																		<select class="table-group-action-input form-control select2" id="top_id">
																			<?php
																				if( !empty($top) ) {
																					foreach($top as $au) {
																						echo"<option value=".$au->top_id.">".$au->kode."</option>";
																					}
																				}
																			?>
																		</select>
																	</div>
																<?php }elseif(!empty($page) && $page == 55){?>
																	<div class="col-md-1">
																		<div class="checkbox-list">
																			<input type="checkbox" name="chk_term" id="is_except_term">
																		</div>
																	</div>
																	<div class="col-md-8">
																		<select class="table-group-action-input form-control select2" id="top_id">
															...
															<div class="form-group">
																...
																<div class="col-md-1">
																	<div class="checkbox-list">
																		<input type="checkbox" name="chk_npwp" id="is_person_tax">
																	</div>
																</div>
																<div class="col-md-8">
															...
															<div class="form-group">
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="person_nm_wp" id="person_nm_wp" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Alamat WP </label>
																<div class="col-md-9">
																	<input type="text" class="form-control" name="person_alamat_wp" id="person_alamat_wp" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Account <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<div class="input-group">
																		<input type="text" class="form-control" name="supplier_acc" id="supplier_acc">
																		<input type="hidden" class="form-control" name="rek_hutang_no" id="rek_hutang_no">
																		<input type="hidden" class="form-control" name="supplier_acc_gol" id="supplier_acc_gol">
																		<span class="input-group-btn">
																			<button class="btn green-seagreen" id="btn-acc-supplier"><i class="fa fa-ellipsis-h"></i></button>
																		</span>
																	</div>
																</div>
															</div>
														...
														<div class="col-md-6" style="padding-right: 30px;">
															<?php if(!empty($page) && $page == 54 ){?>
																<div class="form-group">
																	...
																	<div class="col-md-9">
																		<select class="table-group-action-input form-control select2" id="uang_id">
																			<?php
																				if( !empty($uang) ) {
	    																			foreach($uang as $au) {
																						echo"<option value=".$au->uang_id.">".$au->kode."</option>";
																					}
																				}
																			?>
																		</select>
																...
																<div class="form-group">
																	<label class="col-md-4 control-label" style="text-align:left;color: #10625e;">Informasi Bank
																	</label>
																...
																<div class="form-group">
																	<label class="col-md-3 control-label">Bank Tjn </label>
																	<div class="col-md-9">
																		<input type="text" class="form-control" name="person_bank" id="person_bank" >
																	</div>
																</div>
																<div class="form-group">
																	<label class="col-md-3 control-label">No Acc </label>
																	<div class="col-md-9">
																		<input type="text" class="form-control" name="person_acc" id="person_acc" >
																	</div>
																</div>
																<div class="form-group">
																	<label class="col-md-3 control-label">Atas Nama </label>
																	<div class="col-md-9">
																		<input type="text" class="form-control" name="person_an" id="person_an" >
																	</div>
																</div>
															<?php }elseif(!empty($page) && $page == 55){?>
																<div class="form-group">
																...
																<div class="form-group">
																	...
																	<div class="col-md-8">
																		<select class="table-group-action-input form-control select2" id="jenis_harga">
																...
																<div class="form-group">
																	<label class="col-md-4 control-label">Piutang Limit </label>
																	<div class="col-md-1">
																		<div class="checkbox-list">
																			<input type="checkbox" name="chk_limit" id="is_person_limit">
																		</div>
																	</div>
																	<div class="col-md-7">
																		<input type="text" class="form-control" name="person_limit_piutang" id="person_limit_piutang" >
																	</div>
																</div>
																<div class="form-group">
																	<label class="col-md-4 control-label">Salesman </label>
																	<div class="col-md-8">
																		<select class="table-group-action-input form-control select2" id="salesman">
																		<?php
																			if( !empty($sal) ) {
    																			foreach($sal as $au) {
																					echo"<option value=".$au->sal_no.">".$au->sal_name."</option>";
																				}
																			}
																		?>
																	</select>
...
<!--END MODAL-->
<!--MODAL ADD salesman-->
<div class="modal fade bs-modal-lg" id="add_salesman" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" id="frm-salesman">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-salesman"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-salesman"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-salesman"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-salesman"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
										<ul class="nav nav-tabs">
											<li class="active">
												<a href="#tab_salinfo" data-toggle="tab">
												Infomasi </a>
											</li>
										</ul>
										<div class="tab-content no-space">
											<div class="alert alert-danger alert-dismissible" id="validation-salesman" style="display:none;">
											  <a href="#" class="close" data-dismiss="alert" aria-label="close">x</a>
											</div>
											<div class="alert alert-success alert-dismissible" id="validation-s-salesman" style="display:none;">
											  <a href="#" class="close" data-dismiss="alert" aria-label="close">x</a>
											</div>
											<div class="tab-pane active" id="tab_supinfo">
												<div class="form-body">
														...
														<div class="col-md-6" style="padding-right: 30px;">
															...
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="sal_code" id="sal_code">
																	<input type="hidden" class="form-control" name="id_sal" id="id_sal">
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Nama <span class="required">
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="sal_name" id="sal_name" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Alamat <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<textarea class="form-control" id="sal_alamat"></textarea>
																</div>
															</div>
														</div>
														<div class="col-md-6" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_act_salesman" value="1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_non_salesman" value="0" checked> Non-Active </label>
																	</div>
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Telepon <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<input type="text" class="form-control" name="sal_telp" id="sal_telp" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Contact </label>
																<div class="col-md-9">
																	<input type="text" class="form-control" name="sal_contact" id="sal_contact" >
																</div>
															</div>
														</div>
													</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" id="frm-top">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-top"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-top"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-top"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-top"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
										...
										<div class="tab-content no-space">
											<div class="alert alert-danger alert-dismissible" id="validation-top" style="display:none;">
											  <a href="#" class="close" data-dismiss="alert" aria-label="close">x</a>
											</div>
											<div class="alert alert-success alert-dismissible" id="validation-s-top" style="display:none;">
											  <a href="#" class="close" data-dismiss="alert" aria-label="close">x</a>
											</div>
											<div class="tab-pane active" id="tab_topinfo">
												<div class="form-body">
													<div class="row" style="margin-top:20px;">	
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-6">
																	<input type="text" class="form-control" name="top_code" id="top_code">
																	<input type="hidden" class="form-control" name="id_top" id="id_top">
																</div>
																<div class="col-sm-3">
																	<div class="checkbox-list">
																		<label><input type="checkbox" name="chk_term" id="is_default_term"> Default</label>
																	</div>
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Term <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
															...
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_act_top" value="1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="status_user" id="is_non_top" value="0" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" id="frm-account">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-account"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-account"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-account"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-account"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
										...
										<div class="tab-content no-space">
											<div class="alert alert-danger alert-dismissible" id="validation-account" style="display:none;">
											  <a href="#" class="close" data-dismiss="alert" aria-label="close">x</a>
											</div>
											<div class="alert alert-success alert-dismissible" id="validation-s-account" style="display:none;">
											  <a href="#" class="close" data-dismiss="alert" aria-label="close">x</a>
											</div>
											<div class="tab-pane active" id="tab_supinfo">
												<div class="form-body">
													<div class="row" style="margin-top:20px;">	
														<div class="col-md-12" style="padding-right: 30px;">
															...
															<div class="form-group">
																<label class="col-md-3 control-label">Klasifikasi <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<select class="table-group-action-input form-control select2" id="rek_gol">
																		<option value="0">1. AKTIVA</option>
																	    <option value="1">2. PASIVA</option>
																	    <option value="2">3. MODAL</option>
																	    <option value="3">4. PENDAPATAN</option>
																	    <option value="4">5. BIAYA</option>
																	    <option value="5">6. HARGA POKOK PENJUALAN</option>
																	    <option value="6">7. PENDAPATAN LAIN-LAIN</option>
																	    <option value="7">8. BIAYA LAIN-LAIN</option>
																	</select>
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Group <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="rek_type" id="is_sub_acc" value="0"> Sub Klasifikasi</label>
																		<label class="radio-inline">
																		<input type="radio" name="rek_type" id="is_id_acc" value="1"> Identifikasi </label>
																		<label class="radio-inline">
																		<input type="radio" name="rek_type" id="is_rin_acc" value="2"> Rincian </label>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<div class="col-sm-3" style="padding-left: 0px;">
																		<input type="text" class="form-control" name="rek_kode_head" id="rek_kode_head" readonly="true">
																	</div>
																	<div class="col-sm-3" style="padding-left: 0px;">
																		<input type="text" class="form-control" name="rek_kode_sub" id="rek_kode_sub" disabled="true">
																	</div>
																	<div class="col-sm-3" style="padding-left: 0px;">
																		<input type="text" class="form-control" name="rek_kode_id" id="rek_kode_id" disabled="true">
																	</div>
																	<div class="col-sm-3" style="padding-left: 0px;">
																		<input type="text" class="form-control" name="rek_kode_rin" id="rek_kode_rin" disabled="true">
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-md-9">
																	<div class="checkbox-list">
																		<label class="checkbox-inline"><input type="checkbox" name="chk_status" id="is_kas"> Kas / Bank </label>
																		<label class="checkbox-inline"><input type="checkbox" name="chk_status" id="is_act_account"> Active </label>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="rek_nama" id="rek_nama" >
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Keterangan </span>
																</label>
																<div class="col-md-9">
																	<textarea class="form-control" id="ket1"></textarea>
																</div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">Cabang <span class="required">
																* </span>
																</label>
																<div class="col-md-9">
																	<select class="table-group-action-input form-control select2" id="cab_no">
...
<!--END MODAL-->
<!--MODAL ADD bank-->
<div class="modal fade bs-modal-lg" id="add_bank" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" action="#" id="frm-bank">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-bank"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-bank"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-bank"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn default" id="btn-b-bank"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tabbable">
												...
												<div class="form-body">
													<div class="row" style="margin-top:20px;">	
														<div class="col-md-8" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" name="kode_bank" id="kode_bank">
															...
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<div class="input-group">
																		<input type="text" class="form-control" name="rek_bank_nama" id="rek_bank_nama">
																		<input type="hidden" class="form-control" name="rek_no_bank" id="rek_no_bank">
																		<input type="hidden" class="form-control" name="rek_bank_gol" id="rek_bank_gol">
																		<span class="input-group-btn">
																			<button class="btn green-seagreen" id="btn-bank-acc"><i class="fa fa-ellipsis-h"></i></button>
																		</span>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<div class="radio-list">
																		<label class="radio-inline">
																		<input type="radio" name="status_bank" id="is_act_bank" value="1" checked> Active</label>
																		<label class="radio-inline">
																		<input type="radio" name="status_bank" id="is_non_bank" value="0" checked> Non-Active </label>
																	</div>
																</div>
															</div>
														</div>
														<div class="col-md-4" style="margin-bottom: 30px;">
															...
															<div class="col-sm-12">
																<div class="checkbox-list">
																	<label><input type="checkbox" name="chk_tipe" id="is_jual_bank"> Default Penjualan </label>
																</div>
															</div>
														</div>
													</div>
...
<!--MODAL ADD ORDER PEMBELIAN-->
<div class="modal fade bs-modal-xl right" id="add_purchaseorder" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal form-row-seperated" action="#" id="frm-po">
							<div class="portlet">
								<div class="portlet-title">
									<div class="actions btn-set">
										<button class="btn default" id="btn-r-po"><i class="fa fa-reply"></i> Reset</button>
										<button class="btn green-seagreen" id="btn-s-po"><i class="fa fa-check"></i> Simpan</button>
										<button class="btn green-seagreen" id="btn-rs-po"><i class="fa fa-check-circle"></i> Simpan & Tambah Baru</button>
										<button class="btn green-seagreen" id="btn-c-po"><i class="fa fa-print"></i> Cetak</button>
										<button class="btn default" id="btn-b-po"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="portlet-body">
									<div class="tapoable">
										...
										<div class="tab-content no-space">
											<div class="tab-pane active" id="tab_general">
												<div class="alert alert-danger alert-dismissible" id="validation-po" style="display:none;">
												  <a href="#" class="close" data-dismiss="alert" aria-label="close">x</a>
												</div>
												<div class="alert alert-success alert-dismissible" id="validation-s-po" style="display:none;">
												  <a href="#" class="close" data-dismiss="alert" aria-label="close">x</a>
												</div>
												<div class="form-body">
													<div class="row" style="margin-top:10px;padding: 10px;">	
														<div class="col-md-4">
															<div class="form-group">
																<label class="col-md-12 control-label left">Supplier :
																</label>
																<div class="col-md-12">
																	<div class="input-group">
																	<div class="input-icon">
																		<input type="text" class="form-control" id="po_personname" readonly="">
																		<input type="hidden" class="form-control" id="po_personid">
																	</div>
																	<div class="input-group-btn">
																		<a class="btn btn-default" id="po_show_supplier"><i class="fa fa-ellipsis-h"></i></a>
																	</div>
																</div>
																</div>
															</div>
														...
														<div class="col-md-3">
															<div class="form-group">
																...
																<div class="col-md-12">
																	<input type="text" class="form-control" id="po_noproses" readonly="true">
														...
														<div class="col-md-3">
															<div class="form-group">
																<label class="col-md-12 control-label left">Tanggal PO :
																</label>
																<div class="col-md-12">
																	<input type="datetime-local" class="form-control" id="po_tgl">
																</div>
															</div>
														</div>
														<div class="col-md-2">
															<div class="form-group">
																<label class="col-md-12 control-label left">Term :
																</label>
																<div class="col-md-12">
																	<select class="form-control select2" id="term_po">
																		<?php
																			if( !empty($term) ) {
    																			foreach($term as $ab) {
																					echo"<option value=".$ab->top_id.">".$ab->kode."</option>";
																				}
																			}
																		?>
																	</select>
														...
														<div class="col-md-10">
															<div class="form-group">
																...
																<div class="col-md-12">
																	<input type="text" class="form-control" id="po_ket" >
																</div>
															</div>
														</div>
														<div class="col-md-2">
													...
													<div class="table-scrollable">
														<table class="table table-striped table-bordered" id="tbl_podetail">
															<thead>
																<tr>
																	<!-- <th scope="col" style="text-align:center;width: 150px!important">
																		 Kode Barang
																	</th>
																	<th style="text-align:center;width: 300px!important">
																		 Nama Barang
																	</th>
																	<th style="text-align:center;width: 60px!important">
																		 Satuan
																	</th>
																	<th style="text-align:center;width: 60px!important">
																		 Qty
																	...
																	<th style="text-align:center;width: 150px!important">
																		 Total
																	</th>
														...
														<div class="col-md-8">
															<div class="col-md-6">	
																<div class="col-md-12" style="padding-right: 0;padding-left: 0;">
																	<div class="form-group">
																		<label class="col-md-5 control-label left">Sub Total</label>
																		<div class="col-md-7" style="padding-right: 0;padding-left: 0;">
																			<input style="padding-right: 0;padding-left: 0;" type="number" class="form-control input-sm underline-form right" id="sub_total_po" readonly="true" >
																		</div>
																	</div>
																</div>
																<div class="col-md-12" style="padding-right: 0;padding-left: 0;">
																	<div class="form-group">
																		<label class="col-md-5 control-label left">Disc Faktur</label>
																		<div class="col-md-2" style="padding-right: 0;padding-left: 0;">
																			<input style="padding-right: 0;padding-left: 0;" type="number" class="form-control input-sm underline-form right" id="disc_persen_po" >
																		</div>
																		<label class="col-md-1 control-label" style="padding-right: 0;padding-left: 0;">%</label>
																		<div class="col-md-4" style="padding-right: 0;padding-left: 0;">
																			<input style="padding-right: 0;padding-left: 0;" type="number" class="form-control input-sm underline-form right" id="disc_rp_po" >
																		</div>
																	</div>
																</div>
																<div class="col-md-12" style="padding-right: 0;padding-left: 0;">
																	<div class="form-group">
																		<label class="col-md-2 control-label left">PPN</label>
																		<div class="col-md-2" style="padding-right: 0;padding-left: 0;">
																			<input style="padding-right: 0;padding-left: 0;" type="number" class="form-control input-sm underline-form right" id="ppn_persen_po" >
																		</div>
																		<label class="col-md-1 control-label" style="padding-right: 0;padding-left: 0;">%</label>
																		<div class="col-sm-3" style="padding-right: 0;padding-left: 0;">
																			<select class="form-control input-sm" id="ppn_po" >
																				<option value="0">None</option>
																		...
																		<div class="col-md-4" style="padding-right: 0;padding-left: 0;">
																			<input style="padding-right: 0;padding-left: 0;" type="number" class="form-control input-sm underline-form right" id="ppn_rp_po" >
																		</div>
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label class="col-md-5 control-label left">Grand Total</label>
																	<div class="col-md-7" style="padding-right: 0;padding-left: 0;">
																		<input style="padding-right: 0;padding-left: 0;" type="number" class="form-control input-sm underline-form right" id="total_po" readonly="true">
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="col-md-12" style="padding-right: 30px;">
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="text" class="form-control" autocomplete="username" id="nama_user" >
															...
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="password" class="form-control" autocomplete="new-password" id=pass_user >
																</div>
															</div>
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<input type="password" class="form-control" autocomplete="new-password" id="passkon_user" >
															...
															<div class="form-group">
																...
																* </span>
																...
																<div class="col-md-9">
																	<select class="table-group-action-input form-control select2" id="slc_akse_user">
																		<option value="0">None</option>
																		<?php
																			if( !empty($akses_user) ) {
										...
										<table class="table table-hover" id="datatable_productslist">
											<thead class="thead-dark">
												<tr role="row" class="heading">
													...
													<th width="8%" style="background-color: #367a9a!important;color:white!important;">
														 Persediaan
													</th>
													<th width="8%" style="background-color: #367a9a!important;color:white!important;">
														 Hrg. Beli
										...
										<table class="table table-hover" id="datatable_productslistsingle">
											<thead class="thead-dark">
												<tr role="row" class="heading">
													...
													<th width="3%" style="background-color: #367a9a!important;color:white!important;">
										...
										<table class="table table-hover" id="datatable_productslistsinglebb">
											<thead class="thead-dark">
												<tr role="row" class="heading">
													...
													<th width="27%" style="background-color: #367a9a!important;color:white!important;">
														 Nama&nbsp;Hasil&nbsp;Proses
													</th>
													<th width="28%" style="background-color: #367a9a!important;color:white!important;">
														 Keterangan
													</th>
													<th width="5%" style="background-color: #367a9a!important;color:white!important;">
...
<!--MODAL SHOW SUPPLIER-->
<div class="modal fade bs-modal-lg" id="show_supplier" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
						...
						<form class="form-horizontal form-row-seperated" action="#">
							<div class="portlet">
								<div class="portlet-title">
									...
									<div class="actions btn-set">
										<button class="btn default" data-dismiss="modal" id="sup_btl"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="form-body">
									<div class="row">
										<div class="col-sm-8">
											<div class="input-group input-xlarge">
												<input type="text" class="form-control form-filter input-sm" name="suplist_search" id="suplist_search">
												<span class="input-group-btn">
													<button class="btn btn-sm green-seagreen" id="suplist_searchbtn"><i class="fa fa-search"></i></button>
												</span>
											</div>
										</div>
										<div class="col-sm-4"></div>
									...
									<div class="table-scrollable" style="border: 0px solid #dddddd;margin-top:10px;">
										<table class="table table-hover" id="datatable_supplierlist">
											<thead class="thead-dark">
												<tr role="row" class="heading">
													<th width="15%" style="background-color: #367a9a!important;color:white!important;">
														 Kode
													</th>
													<th width="30%" style="background-color: #367a9a!important;color:white!important;">
														 Nama
													</th>
													<th width="20%" style="background-color: #367a9a!important;color:white!important;">
														 Alamat
...
<!--MODAL SHOW ACCOUNT-->
<div class="modal fade" id="show_account" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
						...
						<form class="form-horizontal form-row-seperated" action="#">
							<div class="portlet">
								<div class="portlet-title">
									...
									<div class="actions btn-set">
										<button class="btn default" data-dismiss="modal" id="acc_btl"><i class="fa fa-times"></i> Batal</button>
									</div>
								</div>
								<div class="form-body">
									<div class="row">
										<div class="col-sm-6">
											<div class="input-group input-xlarge">
												<input type="text" class="form-control form-filter input-sm" name="productlist_search" id="acclist_search">
												<input type="hidden" class="form-control input-sm" name="id_btn" id="id_btn">
												<span class="input-group-btn">
													<button class="btn btn-sm green-seagreen" id="acclist_searchbtn"><i class="fa fa-search"></i></button>
												</span>
											</div>
										</div>
									...
									<div class="table-scrollable" style="border: 0px solid #dddddd;margin-top:10px;">
										<table class="table table-hover" id="datatable_acclist">
											<thead class="thead-dark">
												<tr role="row" class="heading">
													<th width="20%" style="background-color: #367a9a!important;color:white!important;">
														 Kode&nbsp;Account
													</th>
													<th width="75%" style="background-color: #367a9a!important;color:white!important;">
														 Nama&nbsp;Account
													</th>
													<th width="5%" style="background-color: #367a9a!important;color:white!important;">
													</th>
