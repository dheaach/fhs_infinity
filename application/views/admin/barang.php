											...
											<div class="col-sm-3 pdg-search">
												<div class="input-group">
													...
													<div class="input-group-btn">
														...
														<div class="advance-search-toggle" id="search-toggle-barang" style="min-width:500px;display: none;">
															<div class="row">
																<div class="col-sm-12" style="margin:12px 5px 15px;padding-right: 23px;">
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="col-md-12 control-label" style="margin-top:10px;color:#777;">Tipe Barang</label>
																			<div class="col-md-12">
																		...
																		<div class="form-group">
																			<label class="col-md-12 control-label" style="margin-top:10px;color:#777;">Varian Produk</label>
																			<div class="col-md-12">
																		...
																		<div class="form-group">
																			<label class="col-md-12 control-label" style="margin-top:10px;color:#777;">Sub-Varian Produk</label>
																			<div class="col-md-12">
																				<select class="table-group-action-input form-control input-sm dropdown-input select2" name="varian" id="varian_filter">
																					<option value="0">None</option>
																					<?php
																						if( !empty($var) ) {
			    																			foreach($var as $au) {
			    																	?>
																								<option value="<?php echo $au->varian_id;?>" <?php if($varian_id == $au->varian_id){echo "selected='selected'";}?>><?php echo $au->nama;?></option>
																					<?php
																							}
																						}
																					?>
																	...
																	<div class="col-sm-6">
																		<div class="form-group">
																			<label class="col-md-12 control-label" style="margin-top:10px;color:#777;">Merk Produk</label>
																			<div class="col-md-12">
																				<select class="table-group-action-input form-control input-sm dropdown-input select2" name="merk" id="merk_filter">
																					<option value="0">None</option>
																					<?php
																						if( !empty($merk) ) {
			    																			foreach($merk as $au) {
			    																	?>
																								<option value="<?php echo $au->merk_id;?>" <?php if($merk_id == $au->merk_id){echo "selected='selected'";}?>><?php echo $au->nama;?></option>
																					<?php
																							}
																						}
																					?>
																		...
																		<div class="form-group">
																			<label class="col-md-12 control-label" style="margin-top:10px;color:#777;">Rak Produk</label>
																			<div class="col-md-12">
																				<select class="table-group-action-input form-control input-sm dropdown-input select2" name="rak" id="rak_filter">
																					<option value="0">None</option>
																					<?php
																						if( !empty($rak) ) {
			    																			foreach($rak as $au) {
			    																	?>
																								<option value="<?php echo $au->rak_id;?>" <?php if($rak_id == $au->rak_id){echo "selected='selected'";}?>><?php echo $au->nama;?></option>
																					<?php
																							}
																						}
																					?>
																		...
																		<div class="form-group">
																			<label class="col-md-12 control-label" style="margin-top:10px;color:#777;">Rak Warehouse Produk</label>
																			<div class="col-md-12">
																				<select class="table-group-action-input form-control input-sm dropdown-input select2" name="rakwh" id="rakwh_filter">
																					<option value="0">None</option>
																					<?php
																						if( !empty($rak_gud) ) {
			    																			foreach($rak_gud as $au) {
			    																	?>
																								<option value="<?php echo $au->rak_gudang;?>" <?php if($rak_gudang == $au->rak_gudang){echo "selected='selected'";}?>><?php echo $au->nama;?></option>
																					<?php
																							}
																						}
																					?>
													...
													<table class="table table-hover" id="datatable_products">
														<thead class="thead-dark">
															<tr role="row" class="heading">
																...
																<th width="19%" style="background-color: #367a9a!important;color:white!important;">
																	 Nama&nbsp;Barang
																</th>
																<th width="12%" style="background-color: #367a9a!important;color:white!important;">
																	 Kategori
																</th>
																<th width="6%" style="background-color: #367a9a!important;color:white!important;">
																	 Qty
																</th>
																<th width="6%" class="kol-hb" style="background-color: #367a9a!important;color:white!important;">
																	 Harga Beli
																</th>
																<th width="6%" class="kol-hj" style="background-color: #367a9a!important;color:white!important;">
																	 Harga Jual
																</th>
																<th width="6%" style="background-color: #367a9a!important;color:white!important;">
																	 Status
																</th>
																<th width="4%" style="background-color: #367a9a!important;color:white!important;"></th>
															</tr>
														</thead>
														<tbody>
														</tbody>
...
<?php
    ...
    $this->load->view("_partials/firebase.php");
?>
<script>
		...
		function save_brg() {
			...
			var vari = $('#var_brg').val();
			var merk = $('#merk_brg').val();
			var rak = $('#rak_brg').val();
			var rakwh = $('#rakwh_brg').val();
			...
			if(check_user_right(x.id) == 0){
				...
				$.ajax({
					...
					success: function(dataResult){
						...
						$('#var_brg').val(json_data.parent_prod.varian_id).trigger('change');
						$('#merk_brg').val(json_data.parent_prod.merk_id).trigger('change');
						$('#rak_brg').val(json_data.parent_prod.rak_id).trigger('change');
						$('#rakwh_brg').val(json_data.parent_prod.rak_gudang).trigger('change');
		...
		function search_brg() {
        	...
        	var vari = $("#varian_filter").val();
        	var merk = $("#merk_filter").val();
        	var rak = $("#rak_filter").val();
        	var rakwh = $("#rakwh_filter").val();
		    ...
		    let url = new URL(
		      urlist + "/" + keyword + "/" + is_ar + "/" + grp + "/" + kat + "/"+ vari + "/"+ merk + "/"+ rak + "/"+ rakwh + "/" + sts + "/"
		    );
		...
		$('#btn-b-brg').on('click', function(e) {
			...
			$("#grp_brg").select2("val"," ");
			$("#var_brg").select2("val"," ");
			$("#merk_brg").select2("val"," ");
			$("#rak_brg").select2("val"," ");
			$("#rakwh_brg").select2("val"," ");
			$.uniform.update();
			$('#add_product').modal('hide');
			var oTable = $('#datatable_products').DataTable();
			oTable.draw();
