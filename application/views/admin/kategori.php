...
<script>
		...
		function save_kat() {
			...
			var acc_pers = $('#id_acc_pers').val();
			var acc_jual = $('#id_acc_jual').val();
			var acc_ret = $('#id_acc_ret').val();
			var acc_pot = $('#id_acc_pot').val();
			var acc_hpp = $('#id_acc_hpp').val();
	...
	            $.ajax({
					...
					success: function(dataResult){
						...
						$('#id_acc_pers').val(json_data.rek_no_pers);
						$('#kat_pers').val(json_data.rek_kode_pers+" - "+json_data.rek_nama_pers);
						$('#id_acc_jual').val(json_data.acc_jual);
						$('#kat_jual').val(json_data.rek_kode_jual+" - "+json_data.rek_nama_jual);
						$('#id_acc_ret').val(json_data.acc_ret);
						$('#kat_ret').val(json_data.rek_kode_ret+" - "+json_data.rek_nama_ret);
						$('#id_acc_pot').val(json_data.acc_pot);
						$('#kat_pot').val(json_data.rek_kode_pot+" - "+json_data.rek_nama_pot);
						$('#id_acc_hpp').val(json_data.acc_hpp);
						$('#kat_hpp').val(json_data.rek_kode_hpp+" - "+json_data.rek_nama_hpp);
		...
		$('#22B').on('click', function() {
			if(check_user_right(this.id) == 0){
				...
				$.ajax({
					url: "<?php echo base_url("category/get_rek_dasar");?>",
					type: "POST",
					cache: false,
					success: function(dataResult){
						// console.log(dataResult);
		...
		$('#btn-pers-kat').on('click', function(e) {
			e.preventDefault();
			$("#kat_pers_gol").val(-2);
		...
		$('#btn-jual-kat').on('click', function(e) {
			e.preventDefault();
			$("#kat_jual_gol").val(-2);
		...
		$('#btn-ret-kat').on('click', function(e) {
			e.preventDefault();
			$("#kat_ret_gol").val(-2);
		...
		$('#btn-pot-kat').on('click', function(e) {
			e.preventDefault();
			$("#kat_pot_gol").val(-2);
		...
		$('#btn-hpp-kat').on('click', function(e) {
			e.preventDefault();
			$("#kat_hpp_gol").val(-2);
        ...
        function getAccNo(id_acc) {
    		...
    		$.ajax({
				...
				success: function(dataResult){
					var dataResult = JSON.parse(dataResult);
					if(id_btn == 1){
						$('#id_acc_pers').val(dataResult.rek_no);
						$('#kat_pers').val(dataResult.rek_kode+" - "+dataResult.rek_nama);	
					}else if(id_btn == 2){
						$('#id_acc_jual').val(dataResult.rek_no);
						$('#kat_jual').val(dataResult.rek_kode+" - "+dataResult.rek_nama);	
					}else if(id_btn == 3){
						$('#id_acc_ret').val(dataResult.rek_no);
						$('#kat_ret').val(dataResult.rek_kode+" - "+dataResult.rek_nama);	
					}else if(id_btn == 4){
						$('#id_acc_pot').val(dataResult.rek_no);
						$('#kat_pot').val(dataResult.rek_kode+" - "+dataResult.rek_nama);	
					}else if(id_btn == 5){
						$('#id_acc_hpp').val(dataResult.rek_no);
						$('#kat_hpp').val(dataResult.rek_kode+" - "+dataResult.rek_nama);	
					}
				},
				error:function(){
				}
