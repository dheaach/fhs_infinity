		...
		<div class="page-content">
			...
			<div class="page-bar">
				<div class="row">
					<div class="col-sm-10">
						...
						<strong>Daftar Varian</strong>
						</h3>
					</div>
					<div class="add-cat-nav col-sm-2">
						<a class="btn btn-sm green-seagreen" data-toggle="modal" id="23B"><i class="fa fa-plus"></i> Varian Baru</a>
					</div>
				</div>
			...
			<div class="page-bar pg-breadcrumb">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('sub_category');?>">Master Varian</a>
					</li>
				</ul>
			</div>
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin-bottom-20">
												<div class="dashboard-stat db-table">
													...
													<div class="details db-lbl ">
														...
														<div class="desc db-desc">
															 <strong>Varian Non-Aktif</strong>
														</div>
													</div>
												</div>
											</div>
