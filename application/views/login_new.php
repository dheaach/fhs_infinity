  ...
  <link href="<?php echo base_url('assets/images/fhs/fhs-6.png')?>" rel="icon">
  <title>FHSoftware</title>
  ...
  <style type="text/css">
    ...
    .btn-success:not(:disabled):not(.disabled):active{
      ...
      border-color: #1a516c!important;
    }

    .bg-color {
      background-color: #367a9a;
    ...
    .fc-ip:focus {
      border: none;
      border-bottom: 1px solid #367a9a;
    }
    .fc-sc:focus {
      border: 1px solid #367a9a;
    }
    .fc-sc{
      ...
      <div class="d-none d-flex col-md-4 col-lg-6 bg-color align-items-center row fwd">
        <div class="col-sm-12 row">
          <div class="col align-self-start col-sm-1 prg pb-1">
            <img class="img-set" src="<?php echo base_url('assets/images/fhs/fhs-6.png')?>" alt="IMG">
          </div>
          <div class="col align-self-center col-sm-1 gr"><div class="dvd-left dvd-change"></div></div>
          <div class="col align-self-end col-sm-9 text-white ml-0 pl-0 pb-1 txt-arial">
            <h5>FHSoftware</h5>
          </div>
        </div>
        <div class="col-sm-12 text-center">
          <img class="img-ct" src="<?php echo base_url('assets/images/logo/accounting_pink.png')?>" alt="IMG">
        </div>
        <div class="col-sm-12 text-white mt-2">
          <h1 class="font-weight-bold m-0">Welcome</h1>
          <h4 class="mb-2">FHSoftware Accounting</h4>
          <label class="font-small">Software untuk proses pencatatan, pengarsipan, perhitungan serta pembukuan Akuntansi.</label>
        </div>
      </div>
          ...
          <div class="container col-lg-12 pt-1">
            <div class="row pt-1">
              <div class="col-md-12 col-lg-8 mx-auto"> 
                ...
                <h6 class="lbl-lgn font-weight-bold mt-0 mb-3">Aplikasi ini digunakan untuk pencatatan data dan pembukuan Akuntasi.</h6>
                <!-- Sign In Form -->
