var ChartsAmcharts = function() {
    ...
    var initChartSample1 = function() {
        ...
        $.ajax({
          url: BASE_URL + "login/get_bb_usage/"+bb_start+"/"+bb_end+"/",
          type: "POST",
          cache: false,
          success: function(response) {
            ...
            for (var i = 0; i < json_data.length; i++) {
              var dataPoint = {
                nama: json_data[i].nama,
                qty: parseFloat(json_data[i].qty).toFixed(5)
              };
              dataProvider.push(dataPoint);
            }

            // now you can use dataProvider for your chart data
            var chart = AmCharts.makeChart("chart_bb_usage", {
                "type": "serial",
                "theme": "light",
            ...
            $('#chart_bb_usage').closest('.portlet').find('.fullscreen').click(function() {
    ...
    var initChartSample2 = function() {
        ...
        $.ajax({
          url: BASE_URL + "login/get_mnf_usage/"+mnf_start+"/"+mnf_end+"/",
          type: "POST",
          cache: false,
          success: function(response) {
            var json_data = JSON.parse(response);
            ...
            // now you can use dataProvider for your chart data
            var chart = AmCharts.makeChart("chart_mnf_usage", {
                "type": "serial",
                "theme": "light",
                "pathToImages": Metronic.getGlobalPluginsPath() + "amcharts/amcharts/images/",
                "autoMargins": true,
            ...
            $('#chart_mnf_usage').closest('.portlet').find('.fullscreen').click(function() {
                chart.invalidateSize();
            });
          },
          error: function(error) {
