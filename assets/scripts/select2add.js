...
$("#var_brg").each(function() {
  initializeSelect2($(this));
});

$("#merk_brg").each(function() {
  initializeSelect2($(this));
});

$("#rak_brg").each(function() {
  initializeSelect2($(this));
});

$("#rakwh_brg").each(function() {
  initializeSelect2($(this));
});
...
$("#cat_gud_no").each(function() {
  initializeSelect2($(this));
});

$("#slc_akse_user").each(function() {
  initializeSelect2($(this));
});
